...
export const Actividad1TiroLibre: React.FC<Props> = ({ onComplete }) => {
  ...
  return (
    <div className="w-full">
      <p className="text-gray-700 text-base font-semibold mb-4 text-center">El rival va a cobrar un tiro libre. Eres el Portero (Product Owner), organiza tu defensa ante este riesgo.</p>

      <div className="relative w-full rounded-xl overflow-hidden border-4 border-green-800 shadow-inner" style={{ background: '#2E7D32', aspectRatio: '16/9' }}>
