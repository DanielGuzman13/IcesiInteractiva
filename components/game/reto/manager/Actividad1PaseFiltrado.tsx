      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        <div className="flex-1">
          ...
          <p className="text-gray-600 mb-4">
            El &apos;10&apos; (Tú) tiene el balón en el centro del campo. Tienes un compañero buscando el espacio, pero hay <strong>tres defensas rivales</strong> bloqueando las líneas rasantes de pase. ¿Cómo le harás llegar el balón?
          </p>
